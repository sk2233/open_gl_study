...
func (m *MainGame) Init(window *glfw.Window) {
	texture0 := utils.LoadTexture("flynnmnn/test2/test.png")
	texture1 := utils.LoadTexture("flynnmnn/test2/bg.png")
