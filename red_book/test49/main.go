...
func (m *MainGame) Init(window *glfw.Window) {
	...
	m.obj.BindTexture3D(gl.TEXTURE0, utils.Load3DTexture("red_book/test50/bg.png"))
	gl.TexParameteriv(gl.TEXTURE_2D, gl.TEXTURE_SWIZZLE_RGBA, &[]int32{gl.GREEN, gl.BLUE, gl.RED, gl.ONE}[0])
