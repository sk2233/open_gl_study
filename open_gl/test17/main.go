...
func (m *MainGame) Init(window *glfw.Window) {
	...
	m.objShader = frame.NewShader("test17/obj")
	m.objShader.Use()
	m.objShader.Set1i("uImage", 0)
	m.objShader.Set1i("uNormal", 1)
	m.objShader.Set1i("uHeight", 2)
	...
	m.obj.BindTexture(gl.TEXTURE0, utils.LoadTexture("test17/cube.png"))
	m.obj.BindTexture(gl.TEXTURE1, utils.LoadTexture("test17/normal.png"))
	m.obj.BindTexture(gl.TEXTURE2, utils.LoadTexture("test17/height.png"))
}
